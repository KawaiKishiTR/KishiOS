...
void _cdecl printf(const char* fmt, ...){
    ...
    int lenght = PRINTF_LENGHT_START;
    int radix = 10;
    bool sign = false;
        ...
        case PRINTF_STATE_SPEC:
            PRINTF_STATE_SPEC_:
                ...
                case 'c':
                    ...
                    break;
                case 's':
                    if (lenght == PRINTF_LENGHT_LONG || lenght == PRINTF_LENGHT_LONG_LONG){
                ...
                case 'i':
                    radix = 10;
                    sign = true;
                    argp = printf_number(argp, lenght, sign, radix);
                    break;
                case 'u':
                    radix = 10;
                    sign = false;
